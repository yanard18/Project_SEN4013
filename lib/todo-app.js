...
function update(action, model, data) {
  ...
  switch(action) {
    case 'ADD':
      ...
      var input = (typeof document !== 'undefined') ? document.getElementById('new-todo') : null;
    ...
    case 'EDIT':
      ...
      break;
    case 'SAVE':
      var edit = (typeof document !== 'undefined') ? document.getElementsByClassName('edit')[0] : null;
      var value = edit ? edit.value : null;
    ...
    case 'CLEAR_COMPLETED':
      ...
      break;
    case 'ROUTE':
      new_model.hash = (typeof window !== 'undefined' && window.location && window.location.hash) ?
